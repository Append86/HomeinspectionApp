...
const CATEGORY_ICONS = {
  "Structural system and foundation": "🏗️", "Exterior": "🏡", "Plumbing System": "💧",
          ...
          <div className="bg-white rounded-[2.5rem] p-6 shadow-sm border border-slate-200 space-y-6">
            ...
            <div className="grid grid-cols-2 gap-3">
              <div className="space-y-1">
                {/* Fixed: Label color to slate-600 */}
        ...
        {view === 'grid' ? (
          <div className="grid grid-cols-2 gap-4">
            {Object.keys(CATEGORY_ICONS).map((cat) => (
              <button key={cat} onClick={() => { setActiveCategory(cat); setView('list'); }} className="flex flex-col items-center justify-center p-6 bg-white rounded-[2.5rem] shadow-sm border-b-8 border-append-orange active:translate-y-2 transition-all">
          ...
          <div className="animate-in slide-in-from-right duration-300">
            ...
            <h2 className="text-2xl font-black text-append-navy mb-6">{activeCategory}</h2>
